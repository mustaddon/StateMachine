...
public class AdvancedEvent(int id, string name) : IAdvancedEvent
{
    ...
    public static readonly AdvancedEvent E4 = new(4, "Event-4");
...
public class AdvancedEvent<TData, TResult>(int id, string name) : AdvancedEvent(id, name), IFsmEvent<TData, TResult>;
