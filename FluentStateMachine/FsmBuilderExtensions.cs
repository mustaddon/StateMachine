...
public static class FsmBuilderExtensions
{
    ...
    {
        return builder.OnReset(x => { action(x); return CrossFramework.CompletedTask; });
    }
    ...
    {
        return builder.OnExit(x => { action(x); return CrossFramework.CompletedTask; });
    }
    ...
    {
        return builder.OnEnter(x => { action(x); return CrossFramework.CompletedTask; });
    }

    public static FsmBuilder<TState, TEvent> OnJump<TState, TEvent>(this FsmBuilder<TState, TEvent> builder,
        Action<FsmEnterArgs<TState, TEvent>> action)
    {
        return builder.OnJump(x => { action(x); return CrossFramework.CompletedTask; });
    }
    ...
    {
        return builder.OnTrigger(x => { action(x); return CrossFramework.CompletedTask; });
    }

    public static FsmBuilder<TState, TEvent> OnFire<TState, TEvent>(this FsmBuilder<TState, TEvent> builder,
        Action<FsmTriggerArgs<TState, TEvent>> action)
    {
        return builder.OnFire(x => { action(x); return CrossFramework.CompletedTask; });
    }
    ...
    {
        return builder.OnComplete(x => { action(x); return CrossFramework.CompletedTask; });
    }
    ...
    {
        return builder.OnError(x => { action(x); return CrossFramework.CompletedTask; });
    }
